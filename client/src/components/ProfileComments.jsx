        ...
        <form className="space-y-5 mb-10">
            <div className="dark:bg-mixed-700 bg-light-200 flex flex-col max-h-96 rounded-tr-xl rounded-xl">
                <div className="ml-5 mt-4 flex">
                    <div className="rounded-full min-h-12 max-h-12 min-w-12 max-w-12 dark:bg-mixed-900 bg-light-400"></div>
                ...
                <div className="flex">
                    ...
                    <div className=" ml-2 mr-8 p-3 mt-2 mx-auto dark:bg-mixed-700 bg-light-200 shadow-lg dark:shadow-mixed-800 shadow-light-400 rounded-tr-xl rounded-xl">
